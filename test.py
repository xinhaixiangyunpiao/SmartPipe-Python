...
from smartpipe import CpuPipe, StatefulCpuPipe, GpuPipe, GpuAgent
...
"""
    ...
    APP流程：
        | Name   | Type | Stateful | Input        | Output       | Function              | Params     |
        | Task0  | CPU  | No       | None         | Task1, Task5 | Image - Gen           | video, fps |
